...
function PictureCommentNotification({ user, toggleRead }) {
  return (
    <div className={"notif-item notif-item-picture" + unreadChecker(user) } onDoubleClick={toggleRead}>
      ...
      <div className="text-container">
        ...
        <p className="notif-type">commented on your picture</p>
        {user.unread ? (
          <i className="red-dot">
            <svg
              style={{ fill: "red" }}
      ...
      <div className="notif-image-container">
        <img
          src={require("../../images/" + user.picture + ".webp")}
          alt="comment"
        />
      </div>
    </div>
